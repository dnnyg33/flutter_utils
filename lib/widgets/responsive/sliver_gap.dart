...
class SliverGap extends LeafRenderObjectWidget {
  ...
  /// Creates a [SliverGap] with a fixed mainAxisExtent of 4.0.
  const SliverGap.half({super.key, this.color}) : mainAxisExtent = 4.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 8.0.
  const SliverGap.one({super.key, this.color}) : mainAxisExtent = 8.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 12.0.
  const SliverGap.oneAndHalf({super.key, this.color}) : mainAxisExtent = 12.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 16.0.
  const SliverGap.two({super.key, this.color}) : mainAxisExtent = 16.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 24.0.
  const SliverGap.three({super.key, this.color}) : mainAxisExtent = 24.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 32.0.
  const SliverGap.four({super.key, this.color}) : mainAxisExtent = 32.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 40.0.
  const SliverGap.five({super.key, this.color}) : mainAxisExtent = 40.0;

  /// Creates a [SliverGap] with a fixed mainAxisExtent of 64.0.
  const SliverGap.eight({super.key, this.color}) : mainAxisExtent = 64.0;
