...
class Gap extends StatelessWidget {
  ...
  /// Creates a [Gap] with a fixed mainAxisExtent of 4.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.half({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 4.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 8.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.one({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 8.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 12.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.oneAndHalf({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 12.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 16.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.two({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 16.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 24.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.three({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 24.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 32.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.four({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 32.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 40.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.five({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 40.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 48.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.six({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 48.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);

  /// Creates a [Gap] with a fixed mainAxisExtent of 64.0.
  ///
  /// The [crossAxisExtent] must be either null or positive.
  const Gap.eight({super.key, this.crossAxisExtent, this.color})
    : mainAxisExtent = 64.0,
      assert(crossAxisExtent == null || crossAxisExtent >= 0);
